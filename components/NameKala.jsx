      ...
      <Modal
        ...
        >
            ...
            <form  style={setdisplay()} className={classes.root} noValidate autoComplete="off">
                <TextField style={setdisplay()} id="outlined-basic" label={selected ? selected.productName :"نام"} variant="outlined"
                 onChange={(e)=>setNameProd(e.target.value)} align="right"/>
                  ...
                  <NativeSelect
                    placeholder={selected ? selected.category :"دسته بندی"}
                    value={categProd}
                    onChange={handleChange}
                  >
                    <option value="" >
                    {selected ? selected.category :"دسته بندی"}
              </option>
        ...
        <Modal
            ...
            aria-describedby="simple-modal-description"
        >
            <div style={getModalStyle()} className={classes.paper}>حذف کالا <br></br><br></br>
           آیا مطمئن هستی؟<br></br>
            <Button onClick={()=>deleteRow(selected)} variant="contained" color="primary" style={{"width":"45%"}} >آره</Button>&emsp;
            <Button onClick={()=>setOpenDelete(false)} variant="contained" color="primary" style={{"width":"45%"}} >نه</Button>
